...
CD1=zeros(101,35);
for i=1:35
    [CA1(:,i),CD1(:,i)]=dwt(ecg_trinput(:,i),'db2');
end

CA1_test=zeros(101,35);
CD1_test=zeros(101,35);
for i=1:35
    [CA1_test(:,i),CD1_test(:,i)]=dwt(ecg_testinput(:,i),'db2');
end

CA=zeros(52,35);
CD=zeros(52,35);
for i=1:35
    [CA(:,i),CD(:,i)]=dwt(CA1(:,i),'db2');
end

CA_test=zeros(52,35);
CD_test=zeros(52,35);
for i=1:35
    [CA_test(:,i),CD_test(:,i)]=dwt(CA1_test(:,i),'db2');
end
